-- Migration: Create A/B Testing System for Prompt Optimization
-- This creates comprehensive tables and functions for tracking prompt performance

-- Enable necessary extensions
-- CREATE EXTENSION IF NOT EXISTS "uuid-ossp"; -- Usually pre-enabled in Supabase
...
GROUP BY gtd.id, gtd.document_name, gtd.town, gtd.county, gtd.state, 
         gtd.number_of_zones, gtd.document_complexity, gtd.verified_by, gtd.verification_date, gtd.created_at
...
-- Insert a baseline prompt experiment for comparison
INSERT INTO prompt_experiments (
    ...
    'current_production',
    '1.0',
    'Current production prompt - used as baseline for comparison',
    'grok-4-fast-reasoning',
    'Baseline prompt currently used in production system',
    'This serves as the control group for measuring improvements',
    true,
    true
