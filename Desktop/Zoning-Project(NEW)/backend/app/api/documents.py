...
async def upload_document(
    ...
    try:
        ...
        background_tasks.add_task(process_document_background, str(document.id), db)

        logger.info(f"Document uploaded successfully: {original_filename} (ID: {document.id})")
...
async def process_document_background(document_id: str, db: Session):
    ...
    try:
        ...
        try:
            ...
            result = processor.process_document(document_id, background_db)
