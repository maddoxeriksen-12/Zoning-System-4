...
def send_to_zoning_backend(filepath, original_filename, municipality=None, state="NJ"):
...
def upload_file():
    ...
    try:
        ...
        # File uploaded successfully - background processor will handle backend submission
