...
from .core.database import create_tables, get_db, test_connection
...
try:
    ...
    logger.info("Requirements router imported successfully")
except Exception as e:
...
if documents_router:
    ...
    logger.info(f"Documents router included with prefix: /api/documents")
else:
...
async def health_check(db=Depends(get_db)):
    ...
    try:
        ...
        if hasattr(db, 'table'):  # Supabase client
            # Simple test - try to select from a table
