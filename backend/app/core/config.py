...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://zoning_user:zoning_password@postgres:5432/zoning_db")
    SUPABASE_URL: str = os.getenv("SUPABASE_URL", "https://xympjhgrdvcrpdvftgyu.supabase.co")
